...
import co.edu.cecar.smartbooks.viewmodel.NuevoClienteViewModel
...
fun NuevoClienteScreen(
    ...
    val viewModel: NuevoClienteViewModel = viewModel()
    ...
    // Cuando se confirma la fecha en el picker
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                isError = form.errorIdentificacion != null,
                supportingText = form.errorIdentificacion?.let { { Text(it) } },
            ...
            Button(
                ...
                Text(if (state.isGuardando) "Guardando..." else "Guardar cliente")
            }
        }
    }
}