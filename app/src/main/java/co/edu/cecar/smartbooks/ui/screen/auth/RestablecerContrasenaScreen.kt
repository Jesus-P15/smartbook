...
fun RestablecerContrasenaScreen(
    ...
    _root_ide_package_.co.edu.cecar.smartbooks.screens.auth.components.AuthBackground {
        ...
        Column(
            ...
            _root_ide_package_.co.edu.cecar.smartbooks.screens.auth.components.AuthCard {
                ...
                _root_ide_package_.co.edu.cecar.smartbooks.screens.auth.components.AuthTextField(
                    value = correoState,
